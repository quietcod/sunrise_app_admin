...
class ColorResources {
  ...
  static const Color screenBgColorDark = Color(0xFF000000);
  static const Color cardColor = Color(0xffF6F7FE);
  static const Color cardColorDark = Color(0xFF343434);
  ...
  static const Color textFieldEnableBorderColor = colorOrange;
  static const Color hintTextColor = Color(0xff98a1ab);

  // button
  static const Color primaryButtonColor = colorOrange; // orange CTAs
