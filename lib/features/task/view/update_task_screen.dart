                      ...
                      child: Column(
                        children: [
                          ...
                          if (controller.taskRelatedController.text ==
                              'project') ...[
                            const SizedBox(height: Dimensions.space15),
                            controller.isMilestonesLoading
                                ? const CustomLoader(isFullScreen: false)
                                : controller.projectMilestones.isEmpty
                                    ? const SizedBox.shrink()
                                    : CustomDropDownTextField(
                                        hintText: LocalStrings.milestone.tr,
                                        selectedValue:
                                            controller.milestoneController.text,
                                        onChanged: (value) {
                                          controller.milestoneController.text =
                                              value ?? '';
                                        },
                                    ...
                                    if (projectList.data?.status ?? false) {
                                      return CustomDropDownTextField(
                                        ...
                                        onChanged: (value) {
                                          controller.relationIdController.text =
                                              value.toString();
                                          controller.loadProjectMilestones(
                                              value.toString());
                                        },
                                        selectedValue: controller
                                            .relationIdController.text,
