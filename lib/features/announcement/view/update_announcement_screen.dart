...
class UpdateAnnouncementScreen extends StatefulWidget {
  const UpdateAnnouncementScreen({super.key, required this.announcement});
  final Announcement announcement;

  @override
  State<UpdateAnnouncementScreen> createState() =>
      _UpdateAnnouncementScreenState();
}
...
class _UpdateAnnouncementScreenState extends State<UpdateAnnouncementScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Get.find<AnnouncementController>().populateForm(widget.announcement);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<AnnouncementController>(builder: (controller) {
      return Scaffold(
        backgroundColor:
              ...
              Column(
                children: [
                  Padding(
                    ...
                    child: _GlassHeader(
                        isDark: isDark,
                        title: LocalStrings.updateAnnouncement.tr),
                  ),
                  Expanded(
                        ...
                        children: [
                          _GlassCard(
                            ...
                            child: Column(
                              children: [
                                CustomTextField(
                                  labelText: LocalStrings.announcementName.tr,
                                  hintText:
                                      LocalStrings.announcementNameHint.tr,
                                ...
                                CustomTextField(
                                  labelText:
                                      LocalStrings.announcementMessage.tr,
                                  hintText:
                                      LocalStrings.announcementMessageHint.tr,
                          ...
                          controller.isSubmitting
                              ...
                              : RoundedButton(
                                  text: LocalStrings.updateAnnouncement.tr,
                                  press: () => controller.updateAnnouncement(
