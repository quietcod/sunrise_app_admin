...
class _AddAnnouncementScreenState extends State<AddAnnouncementScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Get.find<AnnouncementController>().clearForm();
    });
  }
              ...
              Column(
                children: [
                  Padding(
                    ...
                    child: _GlassHeader(
                        isDark: isDark, title: LocalStrings.addAnnouncement.tr),
                  ),
                  Expanded(
                      ...
                      child: Column(
                        children: [
                          ...
                          controller.isSubmitting
                              ...
                              : RoundedButton(
                                  text: LocalStrings.addAnnouncement.tr,
                                  press: () => controller.addAnnouncement(),
