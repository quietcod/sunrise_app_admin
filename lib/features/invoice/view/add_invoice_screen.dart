...
class _AddInvoiceScreenState extends State<AddInvoiceScreen> {
  ...
  void initState() {
    super.initState();
    // InvoiceController is a shared singleton; ensure it isn't carrying a
    // stale isLoading=true from a previous list-load that would hide the
                ...
                children: [
                  ...
                  FutureBuilder(
                      ...
                      builder: (context, customerList) {
                        if (customerList.connectionState ==
                            ConnectionState.waiting) {
                          return const CustomLoader(isFullScreen: false);
                        }
                        if (customerList.hasError ||
                            customerList.data == null ||
                            !(customerList.data?.status ?? false) ||
                            (controller.customersModel.data?.isEmpty ?? true)) {
