...
class Ticket {
  Ticket({
    ...
    _assignedFullName = assignedFullName;
  ...
  Ticket.fromJson(dynamic json) {
    ...
    _assignedFullName = json['assigned_full_name'];
  ...
  String? get assignedFullName => _assignedFullName;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['assigned_full_name'] = _assignedFullName;
