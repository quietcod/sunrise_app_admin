class TicketDetailsModel {
  ...
  TicketDetailsModel.fromJson(dynamic json) {
    ...
    _data = json['data'] != null ? TicketDetails.fromJson(json['data']) : null;
  }
...
class TicketDetails {
  TicketDetails({
    ...
    _assignedFirstName = assignedFirstName;
    _assignedLastName = assignedLastName;
  ...
  TicketDetails.fromJson(dynamic json) {
    ...
    _assignedName = json['assigned_name'] ?? json['assigned_full_name'];
    _assignedFirstName = json['assigned_firstname'];
    _assignedLastName = json['assigned_lastname'];

    if (json['ticket_replies'] != null) {
      _ticketReplies = [];
      json['ticket_replies'].forEach((v) {
        _ticketReplies?.add(TicketReply.fromJson(v));
      });
    }
  }
  ...
  String? _assignedFirstName;
  String? _assignedLastName;
  List<TicketReply>? _ticketReplies;
  ...
  String? get assignedFirstName => _assignedFirstName;
  String? get assignedLastName => _assignedLastName;
  List<TicketReply>? get ticketReplies => _ticketReplies;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['assigned_name'] = _assignedName;
    map['assigned_firstname'] = _assignedFirstName;
    map['assigned_lastname'] = _assignedLastName;
